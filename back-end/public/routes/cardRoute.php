...
$app->router->addRoute(
    RequestMethod::PATCH, '/boards/{boardId}/columns/{columnId}/cards/{cardId}/assign-to-me',
...
$app->router->addRoute(
    RequestMethod::PATCH, '/boards/{boardId}/columns/{columnId}/cards/{cardId}/assign-to-member',
    [AuthorizeRequest::class],
    [
        CardController::class,
        'assignMemberToCard'
...
$app->router->addRoute(
    RequestMethod::PATCH, '/boards/{boardId}/columns/{columnId}/cards/{cardId}/change-column',
    [AuthorizeRequest::class],
    [
        CardController::class,
        'changeColumnForCard'
...
$app->router->addRoute(
    RequestMethod::PATCH, '/boards/{boardId}/columns/{columnId}/cards/{cardId}/update-description',
    [AuthorizeRequest::class],
    [
        CardController::class,
